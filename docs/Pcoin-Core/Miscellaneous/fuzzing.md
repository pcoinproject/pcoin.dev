---
title: Fuzzing PCOIN Core using libFuzzer
sidebar_position: 2
---
...
To build PCOIN Core using AFL instrumentation (this assumes that the
...
with certain assembly code from PCOIN Core's code. See [developer notes on sanitizers](../Development/developer-notes.md#sanitizers)
